 ...
 void LCD_display(void)
{
 ...
 #endif
#ifdef  _LCD_7
	RasterHparamConfig(SOC_LCDC_0_REGS, 800, 48, 1, 1);

        /* configuring vertical timing parameters */
       RasterVparamConfig(SOC_LCDC_0_REGS, 480, 3, 12, 25);
#endif
...
#if 0
	for(count = 16 ;count < 184016;count ++)
        {
         *(image1 + count) = 0x001F;
        }
	for(count = 184016 ;count < 384016;count ++)
        {
         *(image1 + count) = 0x00F8;
        }
#endif
